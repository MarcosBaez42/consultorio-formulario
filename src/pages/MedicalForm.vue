          ...
          <q-card>
            <q-card-section class="q-pa-md">
              <div class="row q-col-gutter-md">
                ...
                <q-input outlined v-model="formData.fechaNacimiento" mask="date" label="Fecha de nacimiento" class="col-12 col-md-6">
                ...
                <q-input outlined v-model="formData.email" label="Correo electrónico" type="email" class="col-12 col-md-6" />
                <q-input outlined v-model="formData.ocupacion" label="Ocupación" class="col-12 col-md-6" />
                <q-input outlined v-model="formData.ciudadResidencia" label="Ciudad de residencia" class="col-12 col-md-6" />
                 <q-input outlined v-model="formData.fechaConsulta" mask="date" label="Fecha de la consulta" class="col-12">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy cover transition-show="scale" transition-hide="scale">
        ...
        >
          <q-card>
            <q-card-section class="q-pa-md q-gutter-y-md">
              ...
              <q-input outlined v-model="formData.motivoConsulta.deseoMejora" type="textarea" label="¿Qué desea mejorar?" />
              <q-input outlined v-model="formData.motivoConsulta.expectativas" type="textarea" label="Expectativas del tratamiento" />
              <q-input outlined v-model="formData.motivoConsulta.tiempoCondicion" label="Tiempo con la condición estética actual" />

              <q-separator class="q-my-md"/>

              <div class="text-subtitle1 text-weight-bold">Antecedentes Médicos Relevantes</div>
              <q-input outlined v-model="formData.antecedentes.enfermedades" type="textarea" label="Enfermedades previas o actuales" />
              <q-input outlined v-model="formData.antecedentes.cirugiasEsteticas" type="textarea" label="Cirugías estéticas previas" />
              <q-input outlined v-model="formData.antecedentes.alergias" type="textarea" label="Alergias conocidas" />
              <q-input outlined v-model="formData.antecedentes.medicamentos" type="textarea" label="Uso de medicamentos" />
              <q-input outlined v-model="formData.antecedentes.tratamientosPrevios" type="textarea" label="Tratamientos estéticos previos y resultados" />
            </q-card-section>
          </q-card>
        </q-expansion-item>
          ...
          <q-card>
            <q-card-section class="q-pa-md q-gutter-y-md">
              <div class="text-subtitle1 text-weight-bold">Evaluación Facial Estética</div>
               <q-select outlined v-model="formData.evaluacionFacial.tipoPiel" :options="['Seca', 'Grasa', 'Mixta', 'Sensible']" label="Tipo de piel" />
              <q-input outlined v-model="formData.evaluacionFacial.lesionesActivas" label="Lesiones activas (acné, rosácea, manchas, cicatrices)" />
              ...
              <q-input outlined v-model="formData.evaluacionCorporal.grasaLocalizada" label="Zonas de grasa localizada" />
              ...
              <q-input outlined v-model="formData.evaluacionCorporal.retencionLiquidos" label="Retención de líquidos o edemas" />
              <div class="row q-col-gutter-sm">
                  <q-input outlined v-model="formData.evaluacionCorporal.peso" label="Peso (kg)" type="number" class="col-4" />
            ...
            <q-card-section class="q-pa-md q-gutter-y-lg">
                ...
                <q-separator />
                 <div class="text-subtitle1 text-weight-bold">Escala de Baumann (Tipo de Piel)</div>
                  <div class="row q-col-gutter-md">
                    <q-select class="col-6 col-md-3" outlined v-model="formData.escalas.baumann.humedad" :options="['Seca', 'Grasa']" label="Humedad" />
                    <q-select class="col-6 col-md-3" outlined v-model="formData.escalas.baumann.sensibilidad" :options="['Sensible', 'Resistente']" label="Sensibilidad" />
                    <q-select class="col-6 col-md-3" outlined v-model="formData.escalas.baumann.pigmentacion" :options="['Pigmentada', 'No Pigmentada']" label="Pigmentación" />
                    <q-select class="col-6 col-md-3" outlined v-model="formData.escalas.baumann.firmeza" :options="['Arrugada', 'Firme']" label="Firmeza" />
                  </div>
                 <q-input outlined v-model="formData.escalas.baumann.combinacion" label="Combinación final del tipo de piel" />
                <q-separator />
                 <q-option-group
          ...
          <q-card>
            <q-card-section class="q-pa-md q-gutter-y-md">
              <div class="text-subtitle1 text-weight-bold">Evaluación por Impedanciometría Corporal</div>
               <div class="row q-col-gutter-sm">
                  <q-input outlined v-model="formData.impedanciometria.grasaCorporal" label="% de grasa corporal" class="col-6 col-md-4" />
                  <q-input outlined v-model="formData.impedanciometria.masaMuscular" label="Masa muscular" class="col-6 col-md-4" />
                  <q-input outlined v-model="formData.impedanciometria.masaOsea" label="Masa ósea" class="col-6 col-md-4" />
                  <q-input outlined v-model="formData.impedanciometria.aguaCorporal" label="Agua corporal total" class="col-6 col-md-4" />
                  <q-input outlined v-model="formData.impedanciometria.grasaVisceral" label="Índice de grasa visceral" class="col-6 col-md-4" />
                  <q-input outlined v-model="formData.impedanciometria.edadMetabolica" label="Edad metabólica" class="col-6 col-md-4" />
              </div>
              <q-separator class="q-my-md"/>

              <div class="text-subtitle1 text-weight-bold">Análisis Facial con Sistema Cleopatra</div>
              <q-input outlined v-model="formData.cleopatra.resultadoGeneral" type="textarea" label="Resultado del escaneo facial computarizado" />
              <div class="row q-col-gutter-sm">
                <q-input outlined v-model="formData.cleopatra.hidratacion" label="% de hidratación" class="col-6 col-md-4" />
                <q-input outlined v-model="formData.cleopatra.elasticidad" label="% de elasticidad" class="col-6 col-md-4" />
                <q-input outlined v-model="formData.cleopatra.poros" label="Poros (tamaño y cantidad)" class="col-12 col-md-4" />
              </div>
        ...
        >
          <q-card>
            <q-card-section class="q-pa-md q-gutter-y-md">
               ...
               <q-input outlined v-model="formData.planTratamiento.procedimientosFaciales" type="textarea" label="Procedimientos propuestos (faciales)" />
               <q-input outlined v-model="formData.planTratamiento.procedimientosCorporales" type="textarea" label="Procedimientos propuestos (corporales)" />
               <q-input outlined v-model="formData.planTratamiento.sesiones" label="Número de sesiones estimadas" type="number" />
               <q-input outlined v-model="formData.planTratamiento.indicaciones" type="textarea" label="Indicaciones pre y post tratamiento" />
            </q-card-section>
          </q-card>
        </q-expansion-item>
